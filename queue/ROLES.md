...
- **Developer (AI)**
	...
	- Write clean, production-ready code for integrating Celery into this Django project
	- Follow the implementation steps in the README exactly
	- Use best practices for error handling and logging
	- Ensure the code is idempotent and handles retries gracefully
	- Make decisions on code structure, naming, and where to place functions
	- Think through edge cases and potential failures
